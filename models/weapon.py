...
class Weapon(Base):
    ...
    #characteristics
    cout_pa = Column(Integer, nullable=True)
    effets = Column(Integer, nullable=True)
    effets_critiques = Column(Integer, nullable = True)
    portee = Column(Integer, nullable=True)
    #Core Effects
    ...
    #Relationships
    recipes = relationship('Recipe', back_populates='weapon')
    ingredients = relationship('Ingredient', back_populates='weapon')
    monsters = relationship("Monster", secondary="monster_weapon", back_populates="weapons")